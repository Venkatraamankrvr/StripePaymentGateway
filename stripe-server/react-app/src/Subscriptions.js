      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className="well">
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1KZv3RSEDlcIS1XWrRG4ih6D'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1KZv3RSEDlcIS1XWrRG4ih6D')}>
            Choose Monthly Rs200/m
          </button>

          <button
            className={
              'btn ' +
              (plan === 'price_1KZwXtSEDlcIS1XWJcvNuBFI'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1KZwXtSEDlcIS1XWJcvNuBFI')}>
            Choose Quarterly Rs500/q
          </button>
